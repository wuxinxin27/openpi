...
_CONFIGS = [
    ...
    TrainConfig(
        ...
        data=LeRobotEmbodiChainDataConfig(
            ...
            # Example local dataset folder generated by EmbodiChain:
            #   cobotmagic_Sim_manipulate_mixer_duel_000
            repo_id="cobotmagic_Sim_press_button_0508_3_random",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_embodichain_rearrangement",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            # Replace with your EmbodiChain LeRobot dataset repo id.
            # Example local dataset folder generated by EmbodiChain:
            #   cobotmagic_Sim_manipulate_mixer_duel_000
            repo_id="random/cobotmagic_Sim_rearrangement",
            base_config=DataConfig(prompt_from_task=True),
            # EmbodiChain datasets are usually absolute-action targets.
            # Keep this False unless your checkpoint expects extra delta conversion.
            extra_delta_transform=True,
    ...
    TrainConfig(
        name="pi0_embodichain_items_handover_place",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_items_handover_place",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_manipulate_pipette",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi0_embodichain_beaker_mixer",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
    ...
    TrainConfig(
        name="pi0_embodichain_sample_loading_dual",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_sample_loading_dual",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        name="pi0_embodichain_pour_water_dual",
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_pour_water_dual",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_drawer_open_place",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_carry_basket",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
    ...
    TrainConfig(
        ...
        model=pi0_config.Pi0Config(action_horizon=10),
        data=LeRobotEmbodiChainDataConfig(
            repo_id="random/cobotmagic_Sim_open_pan",
            base_config=DataConfig(prompt_from_task=True),
            extra_delta_transform=True,
        ),
        batch_size=32,
